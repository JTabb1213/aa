...
class OKXClient(ExchangeClient):
    ...
    def __init__(self, api_key: str = "", api_secret: str = "", passphrase: str = "", dry_run: bool = True):
        super().__init__(dry_run=dry_run)
        self._api_key = api_key
        self._api_secret = api_secret
        self._passphrase = passphrase
        self._coin_map = self._load_coin_map_from_json("okx")
    ...
    async def _execute_create_order(self, request: OrderRequest) -> OrderResult:
        raise NotImplementedError("OKX live trading not yet implemented")
