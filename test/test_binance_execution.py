#!/usr/bin/env python3
"""
Binance.US Execution Test.

Tests the Binance.US REST trading endpoints to verify auth + connectivity.
...
Usage:
    python test_binance_execution.py
...
async def test_binance():
    ...
    print("=" * 60)
    print("  Binance.US Execution Test")
    print("=" * 60)
    ...
    client = BinanceClient(api_key=api_key, api_secret=api_secret, dry_run=dry_run)
