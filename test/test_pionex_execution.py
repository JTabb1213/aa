#!/usr/bin/env python3
"""
Pionex Execution Test.

Tests the Pionex REST trading endpoints to verify auth + connectivity.
...
Usage:
    python test_pionex_execution.py
...
async def test_pionex():
    ...
    client = PionexClient(api_key=api_key, api_secret=api_secret, dry_run=dry_run)
