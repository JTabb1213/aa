#!/usr/bin/env python3
"""
Bybit Execution Test.

Tests the Bybit v5 REST trading endpoints to verify auth + connectivity.
...
Usage:
    python test_bybit_execution.py
...
async def test_bybit():
    ...
    client = BybitClient(api_key=api_key, api_secret=api_secret, dry_run=dry_run)
